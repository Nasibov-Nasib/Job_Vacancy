...
urlpatterns = [
    ...
    path('post_job_satish/',views.post_job_satish, name="post_job_satish"),
    path('post_job_tibb/',views.post_job_tibb, name="post_job_tibb"),
    path('post_job_neqliyyat/',views.post_job_neqliyyat, name="post_job_neqliyyat"),
    path('post_job_security/',views.post_job_security, name="post_job_security"),
    path('post_job_techizat/',views.post_job_techizat, name="post_job_techizat"),
    path('post_job_senaye/',views.post_job_senaye, name="post_job_senaye"),
    path('post_job_marketinq/',views.post_job_marketinq, name="post_job_marketinq"),
